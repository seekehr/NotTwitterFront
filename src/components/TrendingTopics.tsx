...
const TrendingTopics: React.FC = () => {
    ...
    return (
        <div className="retro-container bg-blue-50">
            <div className="p-4 border-b-2 bg-blue-50 border-black">
            ...
            <div className="p-4">
                <h2 className="font-retro text-xl font-bold mb-4 bg-blue-50">What's Trending</h2>
